...
// RC522 寄存器地址定义
#define MFRC522_REG_COM_IRQ     0x04  // 通信中断寄存器
#define MFRC522_REG_COMM_I_EN    0x02  // 通信中断使能寄存器
#define MFRC522_REG_DIV_I_EN     0x05  // 分频器中断使能寄存器

extern char RawCardID[MFRC522_MAX_LEN]; // 存储从MFRC522模块读取到的卡片ID原始数据

void RC522_Init(void);
void RC522_EXIT_Interrupt(void);
void MFRC522_Configure_IRQ(void);
